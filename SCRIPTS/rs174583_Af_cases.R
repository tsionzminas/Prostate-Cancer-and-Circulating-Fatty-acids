...
infile = file.path(PROJECT_DIR,"RESULTS","rs174583_Af_cases.txt")
...
outfile = file.path(PROJECT_DIR,"RESULTS","rs174583_Af_cases.pdf")
...
title(main="variance explained by rs174583 in Af cases",cex.main=1,line=1)
