...
infile = file.path(PROJECT_DIR,"RESULTS","rs174556_Af_controls.txt")
data = as.matrix(read.table(infile,header=T,check.names=F,stringsAsFactors=F,sep="\t"))

# analysis_of_variance
explanatory_vars = c("rs174556")
...
outfile = file.path(PROJECT_DIR,"RESULTS","rs174556_Af_controls.pdf")
...
title(main="variance explained by rs174556 in Af controls",cex.main=1,line=1)
