...
infile = file.path(PROJECT_DIR,"RESULTS","rs174583_EA_controls.txt")
...
outfile = file.path(PROJECT_DIR,"RESULTS","rs174583_EA_controls.pdf")
...
title(main="variance explained by rs174583 in EA controls",cex.main=1,line=1)
