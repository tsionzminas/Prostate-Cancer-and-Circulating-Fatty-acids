...
infile = file.path(PROJECT_DIR,"RESULTS","rs174583_EA_cases.txt")
...
outfile = file.path(PROJECT_DIR,"RESULTS","rs174583_EA_cases.pdf")
...
title(main="variance explained by rs174583 in EA cases",cex.main=1,line=1)
