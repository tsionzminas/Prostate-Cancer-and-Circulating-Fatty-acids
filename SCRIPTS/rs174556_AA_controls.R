...
infile = file.path(PROJECT_DIR,"DATA","rs174556_AA_controls.txt")
...
outfile = file.path(PROJECT_DIR,"RESULTS","rs174556_AA_controls.pdf")
...
title(main="variance explained by rs174556 in AA controls",cex.main=1,line=1)
