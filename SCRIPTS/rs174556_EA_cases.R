...
infile = file.path(PROJECT_DIR,"RESULTS","rs174556_EA_cases.txt")
...
outfile = file.path(PROJECT_DIR,"RESULTS","rs174556_EA_cases.pdf")
...
title(main="variance explained by rs174556 in EA cases",cex.main=1,line=1)
