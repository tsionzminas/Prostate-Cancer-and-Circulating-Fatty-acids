...
infile = file.path(PROJECT_DIR,"RESULTS","rs174556_AA_cases.txt")
...
outfile = file.path(PROJECT_DIR,"RESULTS","rs174556_AA_cases.pdf")
...
title(main="variance explained by rs174556 in AA cases",cex.main=1,line=1)
